...
def test_sanitize_wind(wind: str, fixed: str) -> None:
    """Test the wind sanitization before checks."""
...
def test_not_double_gust(item: str) -> None:
...
def test_wind_leading_mistype(item: str, clean: str) -> None:
...
def test_not_remove_vrb_leading_digits(item: str) -> None:
