...
def test_joined_cloud(item: str, index: int) -> None:
...
def test_not_joined_cloud(item: str) -> None:
...
def test_joined_timestamp(item: str, index: int) -> None:
...
def test_not_joined_timestamp(item: str) -> None:
...
def test_joined_wind(item: str, index: int) -> None:
...
def test_not_joined_wind(item: str) -> None:
...
def test_joined_taf_new_line(item: str, index: int) -> None:
...
def test_joined_min_max_temperature(item: str, index: int) -> None:
...
def test_not_joined_min_max_temperature(item: str) -> None:
...
def test_joined_runway_visibility(item: str, index: int) -> None:
...
def test_not_joined_runway_visibility(item: str) -> None:
