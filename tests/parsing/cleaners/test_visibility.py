...
def test_visibility_greater_than(item: str):
...
def test_not_visibility_greater_than(item: str):
...
def test_runway_visibility_unit(item: str, clean: str):
...
def test_not_runway_visibility_unit(item: str):
