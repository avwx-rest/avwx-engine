...
class TestGlobal(BaseTest):
    ...
    def test_get_flight_rules(self):
        ...
        for vis, ceiling, rule in (
            ...
            self.assertEqual(static.FLIGHT_RULES[_core.get_flight_rules(vis, ceiling)], rule)
...
class TestTaf(unittest.TestCase):
    ...
    def test_find_missing_taf_times(self):
        ...
        self.assertEqual(_core.find_missing_taf_times(bad_lines, start, end), good_lines)
